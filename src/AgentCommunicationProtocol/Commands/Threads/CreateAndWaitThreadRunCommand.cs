...
/// <summary>
/// Represents the command used to create a run on a thread and to wait for its output.
/// </summary>
[Description("Represents the command used to create a run on a thread and to wait for its output.")]
[DataContract]
public class CreateAndWaitThreadRunCommand
    : Command<StatefulRunExecutionResult>
{
